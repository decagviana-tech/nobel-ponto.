...
import { updateRecord, getTodayRecord, getBankBalance, getEmployees } from '../services/storageService';
...
export const TimeClock: React.FC<Props> = ({ onUpdate, employeeId }) => {
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-2xl mx-auto py-8 animate-fade-in">
      {successMsg && (
        <div className="fixed top-10 bg-slate-900 text-white px-8 py-4 rounded-full shadow-2xl z-50 flex items-center gap-3 border border-slate-700 animate-in slide-in-from-top-10">
